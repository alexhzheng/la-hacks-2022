...
function getOrderConfirmationEmailHtml(metamaskURL, qr) {
  ...
  <body style="width:100%;font-family:Arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
    <div>
    <div>Here is the link to pay him! <a href=${metamaskURL}>link </a> <img src=${dataURLtoFile(
    qr,
    "metamask.png"
  )} alt="qrcode" style="height:100px;width:100px;"/> </div> 
    </div>
  </body>
  </html>`;
}
